...
%%% Description : data loader that sends the data to existing
%%%               db nodes for insertion.
%%%
%%% Created : 30 Jan 2009 by Brad Anderson <brad@sankatygroup.com>
%%%-------------------------------------------------------------------
-module(dataloader).

-behaviour(gen_server).

-define(METHOD, roundrobin).
...
%% NOTE:  State is the next pid to use
%%====================================================================
%% API
%%====================================================================
